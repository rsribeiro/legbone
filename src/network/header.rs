...
pub enum HeaderSend {
    ...
    //412 =       01 00 02 00 03 00 04 00 05 00 0A 00 0B 00 0C 00 0D 00 0E 00 0F 00 12 00 13 00 14 00 15 00 16 00 19 00 1A 00 1B 00 23       00 28 00 32 00 33 00 34 00 3C 00 3D 00 64 00 65 00 66 00 67 00 68 00 C8 00
    ...
    //661 =       01 00 02 00 03 00 04 00 05 00 0A 00 0B 00 0C 00 0D 00 0E 00 0F 00 12 00 13 00 14 00 15 00 16 00 19 00 1A 00 1B 00 23 00 24 00 28 00 32 00 33       00 3C 00 3D 00 64 00 65 00 66 00 67 00 68 00 C8 00
    //694 =

    //Exclusive to protocol Tibia103
    Unknown0x0000 = 0x0000,//Do nothing?
    ...
    //Since Tibia300
    Unknown0x000f = 0x000f,//Field?
    UpdateInventoryItem = 0x0016,
    MagicEffect = 0x001a,
    Text = 0x0023,
    WorldLight = 0x0028,
    UpdateCharacter = 0x0032,
    Unknown0x0033 = 0x0033,//Combat target?
    Stats = 0x003c,
    ...
    Unknown0x0034 = 0x0034,//under attack?
